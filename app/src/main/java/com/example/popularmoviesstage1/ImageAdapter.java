...
//        poster_paths[position].substring(2);
        //w185 http://image.tmdb.org/t/p/w185/d8u4jpkDKgEPDJUl4g3vOOP3mDe.jpg
        poster_paths[position]=poster_paths[position].replace("w185","w500");
        poster_paths[position]=poster_paths[position].replace("http","https");
        System.out.println( poster_paths[position]);
